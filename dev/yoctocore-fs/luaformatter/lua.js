...
const print = do_nothing
const error = do_nothing
...
function minify(src) {
    return luaminp.Minify(src, { RenameVariables: false, RenameGlobals: false, SolveMath: false })
}
function beautify(src) {
    return luaminp.Beautify(src, { RenameVariables: false, RenameGlobals: false, SolveMath: false })
}
